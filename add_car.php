...
if(isset($_POST['model_name'])){
    ...
    $sql = "INSERT INTO `cars` (`id`, `model_name`, `model_year`, `c_number`, `category_id`) VALUES (NULL,?,?,?,?)"; // SQL with parameters
    $stmt = $conn->prepare($sql); 
    $stmt->bind_param("siii", $name,$year,$c_num,$cat_id);
    $stmt->execute();
...
<html lang="en">
    ...
    <body>
        ...
        <form method="POST" action="#">
            ...
            <div class="form-input">
                <input type="text" name="year" placeholder="enter manifacture year"/>
            </div>
            <div class="form-input">
                <input type="text" name="c_num" placeholder="enter chase num"/>
            </div>
            <div class="form-input">

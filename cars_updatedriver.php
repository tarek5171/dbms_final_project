...
if(isset($_POST['client_id'])){
    ...
    $sql = "UPDATE `car_reg` SET clients_id = ? WHERE car_id =?"; // SQL with parameters
    $stmt = $conn->prepare($sql); 
    $stmt->bind_param("ii",$client_id,$car_id);
    $stmt->execute();
    $result = $stmt->get_result(); // get the mysqli result
    ...
    <body>
        ...
        <form method="POST" action="#">
            <div class="form-input">
                <input type="text" name="client_id" placeholder="Enter new client id"/>  
            </div>
            <div class="form-input">

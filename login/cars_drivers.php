...
$sql = "SELECT clients.id, clients.fullname, clients.age FROM driver_reg, clients WHERE driver_reg.client_id = clients.id AND driver_reg.car_id = '".$_SESSION['car_vd_id']."'";

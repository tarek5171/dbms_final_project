...
if(isset($_POST['car_id'])){
    ...
    $sql="SELECT * FROM car_reg, cars WHERE car_reg.car_id=cars.id AND car_reg.branch_id = '".$branch_id."' AND cars.id = '".$car_id."'";
    //$sql="SELECT * FROM car_reg, cars WHERE car_reg.car_id = cars.id AND car_reg.branch_id = '".$branch_id."' AND cars.id = ";
